...
class Node : public cSimpleModule
{
  ...
  protected:
    ...
    virtual int search_ip(IPAddress ip);
    virtual void print_ip(IPAddress ip);
    virtual void print_mac(MACAddress mac);
    /* Busca una dirección ip en la tabla y devuelve la posición*/
